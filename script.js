...
function addingTableBody(array){
    function getInnerText(i, student){
        let message = '';
        switch (i) {
            case 0:message = student.id;
                break;
            case 1:message = `${student.first_name} ${student.last_name}`;
                break;
            case 2:message = student.gender;
                break;
            case 3:message = student.class;
                break;
            case 4:message = student.marks;
                break;
            case 5:message = student.passing ? "Passing" : "Failed";
                break;
            case 6:message = student.email;
                break;    
            default:message = "Wrong index value";
        }
        return message;
    }
    array.forEach(student => {
        ...
        cell.innerText = getInnerText(i, student); 
        }
        tBody.appendChild(row);
    });
}
addingTableBody(students);
